      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-2xl mx-auto">
          <form className="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
            ...
            <div className="mb-6">
              <label htmlFor="projectType" className="block text-sm font-medium text-gray-600 mb-2">
            ...
            <div className="mb-6">
              <label htmlFor="budget" className="block text-sm font-medium text-gray-600 mb-2">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-brand-primary text-white py-3 px-6 rounded-md hover:bg-gradient-primary-dark transition-all duration-300 font-medium shadow-lg hover:shadow-xl"
            >
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 text-gray-500">
              <a href={`mailto:${contactCopy.contactInfo.email}`} className="hover:text-green-600 transition-colors">
                {contactCopy.contactInfo.email}
              </a>
              <a href={`tel:${contactCopy.contactInfo.phone.replace(/[^0-9+]/g, '')}`} className="hover:text-green-600 transition-colors">
